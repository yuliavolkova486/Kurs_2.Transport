...
public class TestTransport {
    public static void main(String[] args) {
        ...
        TheBuses<DriverD> theBuses1 = new TheBuses<>("Mersedes-Benz", "O 6600", 4.5,
                ...
                List.of(mechanic2), TheBuses.Capacity.EXTRA_SMALL);
        ...
        Mechanic.performMaintenance(passengerCars1);
        ...
        station.addTransport(theBuses2);
        station.addTransport(passengerCars1);
